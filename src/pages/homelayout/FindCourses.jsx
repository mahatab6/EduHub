        ...
        <div className='py-16 bg-gradient-to-r from-purple-50 to-blue-50'>
           <div className='text-center mb-12 mt-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div onClick={() => handleCategory("Development")} className=' p-4 rounded-lg border bg-white text-card-foreground shadow-sm h-full text-center hover:shadow-xl transition-shadow card-gradient'>
                ...
                <div onClick={()=> handleCategory("Design")} className='p-4 rounded-lg border bg-white text-card-foreground shadow-sm h-full text-center hover:shadow-xl transition-shadow card-gradient'>
                ...
                <div onClick={()=> handleCategory("Business")} className='p-4 rounded-lg border bg-white text-card-foreground shadow-sm h-full text-center hover:shadow-xl transition-shadow card-gradient'>
                ...
                <div onClick={()=> handleCategory("Personal-Development")} className='p-4 rounded-lg border bg-white text-card-foreground shadow-sm h-full text-center hover:shadow-xl transition-shadow card-gradient'>
